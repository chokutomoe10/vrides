...
func (x *RegisterDriverReq) Reset() {
	*x = RegisterDriverReq{}
...
func (x *RegisterDriverReq) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RegisterDriverReq) ProtoMessage() {}

func (x *RegisterDriverReq) ProtoReflect() protoreflect.Message {
	mi := &file_driver_proto_msgTypes[0]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
...
// Deprecated: Use RegisterDriverReq.ProtoReflect.Descriptor instead.
func (*RegisterDriverReq) Descriptor() ([]byte, []int) {
	return file_driver_proto_rawDescGZIP(), []int{0}
}

func (x *RegisterDriverReq) GetDriverID() string {
	if x != nil {
		return x.DriverID
	}
	return ""
...
func (x *RegisterDriverReq) GetPackageSlug() string {
	if x != nil {
...
func (x *RegisterDriverRes) Reset() {
	*x = RegisterDriverRes{}
...
func (x *RegisterDriverRes) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RegisterDriverRes) ProtoMessage() {}

func (x *RegisterDriverRes) ProtoReflect() protoreflect.Message {
	mi := &file_driver_proto_msgTypes[1]
	if x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RegisterDriverRes.ProtoReflect.Descriptor instead.
func (*RegisterDriverRes) Descriptor() ([]byte, []int) {
	return file_driver_proto_rawDescGZIP(), []int{1}
}

func (x *RegisterDriverRes) GetDriver() *Driver {
	if x != nil {
		return x.Driver
	}
	return nil
...
const file_driver_proto_rawDesc = "" +
	...
	"\tlongitude\x18\x02 \x01(\x01R\tlongitude2\xa1\x01\n" +
	"\rDriverService\x12F\n" +
	"\x0eRegisterDriver\x12\x19.driver.RegisterDriverReq\x1a\x19.driver.RegisterDriverRes\x12H\n" +
	"\x10UnregisterDriver\x12\x19.driver.RegisterDriverReq\x1a\x19.driver.RegisterDriverResB\x1cZ\x1ashared/proto/driver;driverb\x06proto3"
...
var file_driver_proto_goTypes = []any{
	(*RegisterDriverReq)(nil), // 0: driver.RegisterDriverReq
	(*RegisterDriverRes)(nil), // 1: driver.RegisterDriverRes
	(*Driver)(nil),            // 2: driver.Driver
	(*Location)(nil),          // 3: driver.Location
}
var file_driver_proto_depIdxs = []int32{
	2, // 0: driver.RegisterDriverRes.driver:type_name -> driver.Driver
	3, // 1: driver.Driver.location:type_name -> driver.Location
	0, // 2: driver.DriverService.RegisterDriver:input_type -> driver.RegisterDriverReq
	0, // 3: driver.DriverService.UnregisterDriver:input_type -> driver.RegisterDriverReq
	1, // 4: driver.DriverService.RegisterDriver:output_type -> driver.RegisterDriverRes
	1, // 5: driver.DriverService.UnregisterDriver:output_type -> driver.RegisterDriverRes
