...
type DriverServiceClient interface {
	RegisterDriver(ctx context.Context, in *RegisterDriverReq, opts ...grpc.CallOption) (*RegisterDriverRes, error)
	UnregisterDriver(ctx context.Context, in *RegisterDriverReq, opts ...grpc.CallOption) (*RegisterDriverRes, error)
}
...
func (c *driverServiceClient) RegisterDriver(ctx context.Context, in *RegisterDriverReq, opts ...grpc.CallOption) (*RegisterDriverRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RegisterDriverRes)
...
func (c *driverServiceClient) UnregisterDriver(ctx context.Context, in *RegisterDriverReq, opts ...grpc.CallOption) (*RegisterDriverRes, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(RegisterDriverRes)
...
type DriverServiceServer interface {
	RegisterDriver(context.Context, *RegisterDriverReq) (*RegisterDriverRes, error)
	UnregisterDriver(context.Context, *RegisterDriverReq) (*RegisterDriverRes, error)
...
func (UnimplementedDriverServiceServer) RegisterDriver(context.Context, *RegisterDriverReq) (*RegisterDriverRes, error) {
	return nil, status.Error(codes.Unimplemented, "method RegisterDriver not implemented")
}
func (UnimplementedDriverServiceServer) UnregisterDriver(context.Context, *RegisterDriverReq) (*RegisterDriverRes, error) {
...
func _DriverService_RegisterDriver_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DriverServiceServer).RegisterDriver(ctx, req.(*RegisterDriverReq))
	}
...
func _DriverService_UnregisterDriver_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DriverServiceServer).UnregisterDriver(ctx, req.(*RegisterDriverReq))
	}
	return interceptor(ctx, in, info, handler)
}
