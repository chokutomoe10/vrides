...
const file_trip_proto_rawDesc = "" +
	...
	"\vendLocation\x18\x03 \x01(\v2\x10.trip.CoordinateR\vendLocation\"y\n" +
	...
	"\bcarPlate\x18\x04 \x01(\tR\bcarPlate2\x89\x01\n" +
	"\vTripService\x129\n" +
	"\vPreviewTrip\x12\x14.trip.PreviewTripReq\x1a\x14.trip.PreviewTripRes\x12?\n" +
	"\n" +
...
var file_trip_proto_goTypes = []any{
	...
	(*PreviewTripRes)(nil),     // 1: trip.PreviewTripRes
...
var file_trip_proto_depIdxs = []int32{
	2,  // 0: trip.PreviewTripReq.startLocation:type_name -> trip.Coordinate
	2,  // 1: trip.PreviewTripReq.endLocation:type_name -> trip.Coordinate
	...
	1,  // 12: trip.TripService.PreviewTrip:output_type -> trip.PreviewTripRes
